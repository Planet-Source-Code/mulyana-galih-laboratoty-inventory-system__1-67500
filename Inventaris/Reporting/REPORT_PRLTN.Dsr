VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} REPORT_PRLTN 
   Bindings        =   "REPORT_PRLTN.dsx":0000
   Caption         =   "Report Peralatan"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "REPORT_PRLTN.dsx":001F
   MDIChild        =   -1  'True
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item11 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   -2147483647
         Object.Caption         =   "[-- PERALATAN LABORATORIUM --]"
         Alignment       =   2
      EndProperty
      ItemType12      =   3
   ...
   EndProperty
End
Attribute VB_Name = "REPORT_PRLTN"
