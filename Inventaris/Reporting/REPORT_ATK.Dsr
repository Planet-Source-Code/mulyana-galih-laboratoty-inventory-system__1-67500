VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} REPORT_ATK 
   Bindings        =   "REPORT_ATK.dsx":0000
   Caption         =   "Report ATK"
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10245
   Icon            =   "REPORT_ATK.dsx":001F
   MDIChild        =   -1  'True
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item7 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   -2147483647
         Object.Caption         =   "[-- ALAT TULIS KANTOR --]"
         Alignment       =   2
      EndProperty
      ItemType8       =   5
